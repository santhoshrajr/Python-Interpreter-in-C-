...
%type<n> pick_PLUS_MINUS pick_multop pick_unop augassign star_trailer

%type<ast> atom opt_test opt_yield_test pick_yield_expr_testlist_comp test  or_test and_test testlist_comp not_test comparison expr xor_expr and_expr shift_expr arith_expr
term factor power testlist pick_yield_expr_testlist star_EQUAL stmt expr_stmt print_stmt small_stmt simple_stmt funcdef suite 
...
expr_stmt // Used in: small_stmt
	...
	if(error == 0 && $3 != NULL){
	  		...
	  		if($2==0)
	  		{
	  			...
	  			ast = new BinaryAddNode('+',$1,$3);
	  			

	  		}
	  		else if($2==1)
	  		{
	  			ast = new BinaryMinNode('-',$1,$3);
	  			
	  		}
	  		else if($2==2)
	  		{
	  			ast = new BinaryMulNode('*',$1,$3);
	  			
	  		}
	  		else if($2==3)
	  		{
	  			ast = new BinaryDivNode('/',$1,$3);
	  			
	  		}
	  		else if($2==4)
	  		{
	  			ast = new BinaryModNode('%',$1,$3);
	  			
	  		}
	  		else if($2==5)
	  		{
	  			ast = new BinaryDslashNode('S',$1,$3);
	  		...
	  		$$=(ast==NULL)?NULL:new ExprNode('X',$1,ast);
...
term // Used in: arith_expr, term
	...
	| term pick_multop factor
	{
		if($2==0)
		{
			$$=new BinaryMulNode('*',$1,$3);
		}
		else if($2==1)
		{
			$$=new BinaryDivNode('/',$1,$3);
		}
		else if($2==2)
		{
...
factor // Used in: term, factor, power
	: pick_unop factor
	{
		if($1==0)
		{
			$$=new UnaryPlusNode('P',$2,NULL);
		}
		else if($1==1)
		{
			$$=new UnaryMinNode('M',$2,NULL);
		}
		else if($1==2)
		{
		$$=new UnaryTildaNode('T',$2,NULL);
		}
	}
	| power
